    ...
    private function getProductsData(): array
    {
        return [
            ...
            [
                ...
                'price' => 52000,
                'compare_price' => 58000,
                'short_description' => 'Mono Laser, Print/Scan/Copy/Fax, Duplex, WiFi, 40ppm',
                'description' => 'Professional multifunction laser printer with fast printing speeds and wireless connectivity.',
                'featured' => true,
                'stock' => 12,
                'specs' => [
                    'Basic Information' => [
                    ...
                    'Connectivity' => [
                        'Interfaces' => 'USB 2.0, Ethernet, WiFi, WiFi Direct',
                        'Mobile Printing' => 'Apple AirPrint, HP Smart App',
                    ],
                ],
            ],
            [
                ...
                'brand' => 'Brother',
                'price' => 18500,
                'short_description' => 'Mono Laser, Duplex, WiFi, 34ppm, Mobile Print',
                'description' => 'Compact mono laser printer ideal for small offices and home use.',
                'stock' => 20,
                'specs' => [
                    'Basic Information' => [
                        'Type' => 'Mono Laser',
            ...
            [
                ...
                'brand' => 'HP',
                'price' => 78000,
                'short_description' => 'Color Laser MFP, Print/Scan/Copy/Fax, Duplex, WiFi, 28ppm',
                'description' => 'Professional color laser multifunction printer for high-quality color documents.',
                'featured' => true,
                'stock' => 8,
            ],
            [
                'name' => 'Canon imageCLASS MF269dw II',
                'sku' => 'CAN-MF269DW2',
                'category' => 'Laser Printer',
                'brand' => 'Canon',
                'price' => 32000,
                'short_description' => 'Mono Laser MFP, Duplex, WiFi, 30ppm, ADF',
                'description' => 'Reliable multifunction laser printer with automatic document feeder.',
                'stock' => 15,
            ],

            // Printers - Ink Tank
            [
                'name' => 'Epson EcoTank L3250 WiFi Printer',
                'sku' => 'EPS-L3250',
                'category' => 'Ink Tank Printer',
                'brand' => 'Epson',
                'price' => 22500,
                'compare_price' => 25000,
                'short_description' => 'Print/Scan/Copy, WiFi, High Yield Ink Tank',
                'description' => 'Ultra-low cost printing with high-capacity ink tanks. Print up to 4,500 pages black and 7,500 pages color.',
                'featured' => true,
                'stock' => 25,
                'specs' => [
                    'Basic Information' => [
                        ...
                        'Print Speed' => '10 ipm (Black), 5 ipm (Color)',
                        'Resolution' => '5760 x 1440 dpi',
                    ],
                    'Connectivity' => [
                        'Interfaces' => 'USB 2.0, WiFi, WiFi Direct',
                        'Mobile Printing' => 'Epson Smart Panel, Apple AirPrint',
                    ],
                ],
            ],
            [
                'name' => 'Epson EcoTank L5290 WiFi All-in-One',
                'sku' => 'EPS-L5290',
                'category' => 'Ink Tank Printer',
                'brand' => 'Epson',
                'price' => 32000,
                'short_description' => 'Print/Scan/Copy/Fax, WiFi, ADF, Ethernet',
                'description' => 'Business ink tank printer with fax and ADF for productive office printing.',
                'stock' => 18,
            ],
            [
                'name' => 'Canon PIXMA G3020 Ink Tank Printer',
                'sku' => 'CAN-G3020',
                'category' => 'Ink Tank Printer',
                'brand' => 'Canon',
                'price' => 18500,
                'short_description' => 'Print/Scan/Copy, WiFi, Refillable Ink Tank',
                'description' => 'Affordable ink tank printer for home and small office use.',
                'stock' => 22,
            ],
            [
                ...
                'brand' => 'HP',
                'price' => 24500,
                'short_description' => 'Print/Scan/Copy, WiFi, Bluetooth, High Yield',
                'description' => 'Smart ink tank printer with easy setup and mobile printing.',
                'stock' => 20,
            ],
            [
                ...
                'brand' => 'Brother',
                'price' => 26500,
                'short_description' => 'Print/Scan/Copy, WiFi, Duplex, ADF',
                'description' => 'Feature-rich ink tank printer with automatic duplex printing.',
                'stock' => 15,
            ],

            // Label Printers
            [
                'name' => 'Zebra ZD421 Thermal Label Printer',
                'sku' => 'ZEB-ZD421',
                'category' => 'Label Printer',
                'brand' => 'Zebra',
                'price' => 42000,
                'short_description' => 'Direct Thermal, 203 dpi, USB, Ethernet, Bluetooth',
                'description' => 'Professional desktop label printer for barcode and shipping labels.',
                'featured' => true,
                'stock' => 10,
                'specs' => [
                    'Basic Information' => [
                        ...
                        'Max Label Width' => '108 mm',
                    ],
                    'Connectivity' => [
                        'Interfaces' => 'USB, Ethernet, Bluetooth 4.1',
                    ],
                ],
            ],
            [
                ...
                'brand' => 'TSC',
                'price' => 18500,
                'short_description' => 'Direct Thermal/Thermal Transfer, 203 dpi, USB',
                'description' => 'Affordable desktop barcode printer for retail and logistics.',
                'stock' => 15,
            ],
            [
                'name' => 'Honeywell PC42t Label Printer',
                'sku' => 'HON-PC42T',
                'category' => 'Label Printer',
                'brand' => 'Honeywell',
                'price' => 22000,
                'short_description' => 'Thermal Transfer, 203 dpi, USB, Ethernet',
                'description' => 'Compact and reliable label printer for various industries.',
                'stock' => 12,
            ],
            [
                ...
                'brand' => 'Brother',
                'price' => 28000,
                'short_description' => 'Professional Label Printer, WiFi, Bluetooth, Ethernet',
                'description' => 'Professional label printer with multiple connectivity options.',
                'stock' => 10,
            ],

            // POS Printers
            [
                'name' => 'Epson TM-T82III POS Receipt Printer',
                'sku' => 'EPS-TMT82III',
                'category' => 'POS Printer',
                'brand' => 'Epson',
                'price' => 18500,
                'short_description' => 'Thermal Receipt, 250mm/s, USB, Serial',
                'description' => 'Fast and reliable thermal receipt printer for retail POS systems.',
                'featured' => true,
                'stock' => 20,
                'specs' => [
                    'Basic Information' => [
            ...
            [
                'name' => 'Epson TM-T20III POS Printer',
                'sku' => 'EPS-TMT20III',
                'category' => 'POS Printer',
                'brand' => 'Epson',
                'price' => 14500,
                'short_description' => 'Thermal Receipt, 250mm/s, USB, Auto Cutter',
                'description' => 'Entry-level thermal receipt printer for small businesses.',
                'stock' => 25,
            ],
            [
                'name' => 'HP Engage One Prime Receipt Printer',
                'sku' => 'HP-ENGAGERECEIPT',
                'category' => 'POS Printer',
                'brand' => 'HP',
                'price' => 22000,
                'short_description' => 'Thermal Receipt, USB, 350mm/s, Compact Design',
                'description' => 'Stylish and fast receipt printer for modern retail environments.',
                'stock' => 12,
            ],
            ...
            [
                ...
                'brand' => 'Canon',
                'price' => 16500,
                'short_description' => 'Dye-Sublimation, 4x6 Photos, WiFi, USB',
                'description' => 'Compact photo printer for high-quality borderless photo prints.',
                'stock' => 15,
            ],
            [
                ...
                'brand' => 'Epson',
                'price' => 78000,
                'short_description' => '6-Color Ink Tank, A3+, WiFi, Duplex, CD/DVD Print',
                'description' => 'Professional photo printer with 6-color ink system for stunning photo prints.',
                'featured' => true,
                'stock' => 6,
            ],
            ...
            [
                ...
                'brand' => 'HP',
                'price' => 8500,
                'short_description' => 'Original HP Toner, 3,100 Pages, Black',
                'description' => 'Original HP toner cartridge for LaserJet Pro M402/M426 series.',
                'stock' => 50,
            ],
            [
                ...
                'brand' => 'HP',
                'price' => 9500,
                'short_description' => 'Original HP Toner, 3,000 Pages, Black',
                'description' => 'Original HP toner for LaserJet Pro M404/M428 series printers.',
                'stock' => 45,
            ],
            [
                ...
                'brand' => 'Canon',
                'price' => 7500,
                'short_description' => 'Original Canon Toner, 3,100 Pages, Black',
                'description' => 'Original Canon toner for imageCLASS LBP/MF series.',
                'stock' => 40,
            ],
            [
                'name' => 'Brother TN-2480 Black Toner',
                'sku' => 'BRO-TN2480',
                'category' => 'Toner',
                'brand' => 'Brother',
                'price' => 5500,
                'short_description' => 'Original Brother Toner, 3,000 Pages, Black',
                'description' => 'Original Brother toner for HL-L2375DW and MFC-L2750DW.',
                'stock' => 55,
            ],
            ...
            [
                ...
                'brand' => 'Epson',
                'price' => 450,
                'short_description' => 'Original Epson Ink, 65ml, Black',
                'description' => 'Original Epson ink bottle for EcoTank L3150/L3250/L5190 series.',
                'stock' => 100,
            ],
            [
                ...
                'brand' => 'Epson',
                'price' => 450,
                'short_description' => 'Original Epson Ink, 65ml, Cyan',
                'description' => 'Original Epson cyan ink bottle for EcoTank series.',
                'stock' => 80,
            ],
            [
                'name' => 'Epson 003 Magenta Ink Bottle',
                'sku' => 'EPS-003-M',
                'category' => 'Ink Cartridge',
                'brand' => 'Epson',
                'price' => 450,
                'short_description' => 'Original Epson Ink, 65ml, Magenta',
                'description' => 'Original Epson magenta ink bottle for EcoTank series.',
                'stock' => 80,
            ],
            [
                ...
                'brand' => 'Epson',
                'price' => 450,
                'short_description' => 'Original Epson Ink, 65ml, Yellow',
                'description' => 'Original Epson yellow ink bottle for EcoTank series.',
                'stock' => 80,
            ],
            [
                'name' => 'Canon GI-71 Black Ink Bottle',
                'sku' => 'CAN-GI71-BK',
                'category' => 'Ink Cartridge',
                'brand' => 'Canon',
                'price' => 550,
                'short_description' => 'Original Canon Ink, 135ml, Black',
                'description' => 'Original Canon ink bottle for PIXMA G series printers.',
                'stock' => 70,
            ],
            [
                'name' => 'HP GT52 Cyan Ink Bottle',
                'sku' => 'HP-GT52-C',
                'category' => 'Ink Cartridge',
                'brand' => 'HP',
                'price' => 650,
                'short_description' => 'Original HP Ink, 70ml, Cyan',
                'description' => 'Original HP ink bottle for Smart Tank series.',
                'stock' => 60,
            ],

            // Printer Accessories - Drum Unit
            [
                'name' => 'Brother DR-2455 Drum Unit',
                'sku' => 'BRO-DR2455',
                'category' => 'Drum Unit',
                'brand' => 'Brother',
                'price' => 4500,
                'short_description' => 'Original Brother Drum, 12,000 Pages',
                'description' => 'Original Brother drum unit for HL-L2375DW and MFC-L2750DW.',
                'stock' => 25,
            ],
            [
                'name' => 'Canon 057 Drum Cartridge',
                'sku' => 'CAN-057-DRUM',
                'category' => 'Drum Unit',
                'brand' => 'Canon',
                'price' => 5500,
                'short_description' => 'Original Canon Drum, 23,000 Pages',
                'description' => 'Original Canon drum cartridge for imageCLASS series.',
                'stock' => 20,
            ],

            // Printer Paper
            [
                'name' => 'Double A A4 Paper (5 Reams)',
                'sku' => 'DA-A4-5REAM',
                'category' => 'Printer Paper',
                'brand' => 'HP',
                'price' => 2800,
                'short_description' => '80gsm, A4, 500 Sheets x 5, Premium Quality',
                'description' => 'Premium quality A4 paper for all printers. Smooth finish for professional documents.',
                'stock' => 100,
            ],
            [
                'name' => 'HP Everyday A4 Paper (500 Sheets)',
                'sku' => 'HP-A4-500',
                'category' => 'Printer Paper',
                'brand' => 'HP',
                'price' => 650,
                'short_description' => '75gsm, A4, 500 Sheets',
                'description' => 'Reliable everyday paper for general printing needs.',
                'stock' => 150,
            ],
            [
                'name' => 'Epson Premium Glossy Photo Paper A4',
                'sku' => 'EPS-GLOSS-A4',
                'category' => 'Printer Paper',
                'brand' => 'Epson',
                'price' => 1200,
                'short_description' => '255gsm, A4, 20 Sheets, Glossy',
                'description' => 'Premium glossy photo paper for vibrant photo prints.',
                'stock' => 60,
            ],
            [
                'name' => 'Canon Photo Paper Pro Platinum A4',
                'sku' => 'CAN-PHOTO-A4',
                'category' => 'Printer Paper',
                'brand' => 'Canon',
                'price' => 1500,
                'short_description' => '300gsm, A4, 20 Sheets, Professional Grade',
                'description' => 'Professional grade photo paper for museum-quality prints.',
                'stock' => 40,
            ],
        ];
    }
